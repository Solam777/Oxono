...
class GameTest {
    ...
    void playPawn() {
        ...
        game.playPawn(new Position(2, 2), pawn);
    ...
    void checkWin() {
        ...
        game.playPawn(new Position(1, 1), pawn);

        game.playTotem(new Position(2,2),totem);
        game.playPawn(new Position(1, 2), pawn);

        game.playTotem(new Position(2, 3), totem);
        game.playPawn(new Position(1, 3), pawn);

        game.playTotem(new Position(2, 4), totem);
        game.playPawn(new Position(1, 4), pawn);
    ...
    void undo() {
        ...
        Totem totem = new Totem(Mark.X);
        game.playTotem(new Position(2,3),totem);
        game.playPawn(new Position(2, 4), pawn);
        game.undo();
